...
public class ConfiguracionScreen implements Screen {
    ...
    public void show() {
        ...
        flechaIzq = new TextureRegionDrawable(new TextureRegion(new Texture(Gdx.files.internal("imgMenus/btn_flecha_izq.png"))));
        flechaDer = new TextureRegionDrawable(new TextureRegion(new Texture(Gdx.files.internal("imgMenus/btn_flecha_der.png"))));

        mouseNormal = new TextureRegionDrawable(new TextureRegion(new Texture(Gdx.files.internal("imgMenus/btn_mouse_normal.png"))));
        mouseActivo = new TextureRegionDrawable(new TextureRegion(new Texture(Gdx.files.internal("imgMenus/btn_mouse_act.png"))));
        tecladoNormal = new TextureRegionDrawable(new TextureRegion(new Texture(Gdx.files.internal("imgMenus/btn_teclado_normal.png"))));
        tecladoActivo = new TextureRegionDrawable(new TextureRegion(new Texture(Gdx.files.internal("imgMenus/btn_teclado_act.png"))));

        btnVolverNormal = new TextureRegionDrawable(new TextureRegion(new Texture(Gdx.files.internal("imgMenus/btn_volver.png"))));
    ...
    private void actualizarIdiomaGlobal() {
        ...
        lblIdiomaSeleccionado.setText(seleccion);
